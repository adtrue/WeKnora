export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: "欢迎使用 AdTrue KB",
        desc: "只需几步，带你快速了解知识库、对话与智能体的核心用法。点击「下一步」开始。",
      },
      knowledge: {
        title: "创建你的知识库",
        desc: "知识库是一切的起点：上传文档、网页或 FAQ，AdTrue KB 会自动解析并建立索引。点击这里进入知识库。",
      },
      chat: {
        title: "发起智能对话",
  ...
  auth: {
    ...
    firstTime: "首次使用 AdTrue KB？",
    registerSuccess: "注册成功，请登录",
    registerFailed: "注册失败",
    subtitle: "RAG 问答、ReAct 智能体与 Wiki 知识库，大模型驱动的企业级知识框架",
    registerSubtitle: "创建账户并开始使用 AdTrue KB",
  ...
  createChat: {
    title: "Hi，我是 AdTrue KB，让你的知识触手可及",
    newSessionTitle: "新会话",
    messages: {
